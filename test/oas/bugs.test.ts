import { TEST_DEFAULTS_FLAG, TEST_SEMANTIC_HASH_PROPERTY, TEST_SYNTHETIC_ALL_OF_FLAG } from '../helpers/index'
import {
  denormalize,
  HashOptions,
...
describe('Bugs', () => {
  ...
  it('make denormalize inside custom symbols', () => {
    ...
    expect(normalized).toHaveProperty(['components', 'schemas', 'From', TEST_SEMANTIC_HASH_PROPERTY])
    ...
    expect(result).not.toHaveProperty(['components', 'schemas', customSymbol, TEST_SEMANTIC_HASH_PROPERTY])
  })
