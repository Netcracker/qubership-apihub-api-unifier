...
// --- Column / ColumnType ---
export const DDL_API_PROPERTY_TYPE = 'type'
...
export const DDL_API_PROPERTY_X = 'x'
export const DDL_API_PROPERTY_C = 'c'
...
// --- SchemaType members ---
export const DDL_API_PROPERTY_T = 't'
...
export const DDL_API_PROPERTY_V = 'v'
export const DDL_API_PROPERTY_EXPR = 'expr'
